...
const ExperienceTab = () => {
  ...
  const emphasis = useColorModeValue('site.light', 'site.dark')
  const borderColor = useColorModeValue('gray.300', 'gray.600')
  const activeBordercolor = useColorModeValue('site.light', 'site.dark')
        ...
        {ExperiencesList.map((company) => (
          <Tab
            ...
            _selected={{
              ...
              boxShadow: 'none',
              borderLeftWidth: tabOrientation === 'vertical' ? '6px' : '0',
              borderBottomWidth: tabOrientation === 'horizontal' ? '6px' : '0',
